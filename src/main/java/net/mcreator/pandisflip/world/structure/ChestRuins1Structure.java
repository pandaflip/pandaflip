...
package net.mcreator.pandisflip.world.structure;
...
public class ChestRuins1Structure extends PandisflipModElements.ModElement {
	public ChestRuins1Structure(PandisflipModElements instance) {
		super(instance, 10);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("pandisflip", "chestruinsground1"));
						if (template == null)
							return false;
